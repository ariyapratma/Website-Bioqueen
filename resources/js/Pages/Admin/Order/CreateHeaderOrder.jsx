// resources/js/Pages/CreateHeaderOrder.jsx

import { useForm } from "@inertiajs/react";
import Swal from "sweetalert2";
import { Head } from "@inertiajs/react";

const CreateHeaderOrder = () => {
    ...
    post("/header-order", {
      onSuccess: () => {
        Swal.fire({
          ...
          window.location.href = "/header-order";
        });
      },
      onError: () => {
        Swal.fire({
  ...
  return (
    <div className="bg-white p-6">
      <Head title="Add Header Order | PT Ratu Bio Indonesia" />
      <h1 className="mb-6 text-2xl font-bold">Add New Header Order</h1>
...
export default CreateHeaderOrder;
