// resources/js/Pages/CreateHeroCompany.jsx
...
const CreateHeroCompany = () => {
    ...
    post("/hero-company", {
      onSuccess: () => {
        Swal.fire({
          ...
          window.location.href = "/hero-company";
        });
      },
      onError: () => {
        Swal.fire({
  ...
  return (
    <div className="bg-white p-6">
      <Head title="Add Hero Company | PT Ratu Bio Indonesia" />
      <h1 className="mb-6 text-2xl font-bold">Add New Hero Company</h1>
