            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {dataHeroAboutUs.map((heroAboutUs) => (
                <tr key={heroAboutUs.id}>
                  ...
                  <td className="max-w-xs truncate whitespace-nowrap px-6 py-4 font-lexend text-sm text-gray-700">
                    {`${heroAboutUs.description1} ${heroAboutUs.description2} ${heroAboutUs.description3}`}
                  </td>
                  <td className="whitespace-nowrap px-6 py-4 text-center font-lexend text-sm text-gray-700">
                    <a
