...
const CreateHeroVisionMision = ({ auth }) => {
  ...
  const handleSubmit = (e) => {
    ...
    post("/hero-vision-mision", {
      data: formData,
      onSuccess: () => {
        Swal.fire({
          title: "Success!",
          text: "Hero Vision Mision has been added successfully.",
          icon: "success",
      ...
      onError: () => {
        Swal.fire({
          title: "Error!",
          text: "There was an error adding the Hero Vision Mision.",
          icon: "error",
          confirmButtonText: "OK",
          confirmButtonColor: "#000000",
          scrollbarPadding: false,
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="mt-16 flex-1 bg-neutral-50 p-6">
        <Head title="Create Hero Vision Mision | PT Ratu Bio Indonesia" />
        <Navbar auth={auth} />
        {/* Breadcrumb */}
        <nav className="mb-4 flex items-center space-x-2 font-lexend text-sm text-gray-600">
          ...
          <span className="font-bold text-black">
            Create Hero Vision Mision
          </span>
        </nav>
        {/* Title */}
        <h2 className="mb-4 font-lexend text-xl font-bold">
          Create Vision Mision Page Content
        </h2>
        {/* Form */}
        <form
        ...
        >
          ...
          >
            {processing ? "Saving..." : "Save Hero Vision Mision"}
          </button>
        </form>
      </div>
    </div>
...
export default CreateHeroVisionMision;
