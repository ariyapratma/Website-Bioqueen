...
const EditHeroFacilitiesValue = ({ dataHeroFacilitiesValue, auth }) => {
  ...
  const handleSubmit = (e) => {
    ...
    put(`/hero-facilities-value/${dataHeroFacilitiesValue.id}`, {
      data: formData,
      onSuccess: () => {
        Swal.fire({
          title: "Success!",
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 bg-neutral-50 p-6">
        ...
        >
          ...
          >
            {processing ? "Saving..." : "Update Hero Facilities Value"}
          </button>
        </form>
      </div>
    </div>
