...
const CreateHeroFacilitiesValue = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post("/hero-facilities-value", {
      onSuccess: () => {
        Swal.fire({
          title: "Success!",
          text: "Hero Facilities Value has been added successfully.",
          icon: "success",
      ...
      onError: () => {
        Swal.fire({
          title: "Error!",
          text: "There was an error adding the Hero Facilities Value.",
          icon: "error",
          confirmButtonText: "OK",
        });
      },
  ...
  return (
    <div className="bg-white p-6">
      <Head title="Add Hero Facilities Value | PT Ratu Bio Indonesia" />
      <h1 className="mb-6 text-2xl font-bold">Add New Hero Facilities Value</h1>
...
export default CreateHeroFacilitiesValue;
