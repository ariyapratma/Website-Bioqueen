// resources/js/Pages/ManageHeaderContact.jsx

import { Link, Head, useForm } from "@inertiajs/react";
import Swal from "sweetalert2";

const ManageHeaderContact = ({ dataHeaderContact }) => {
  ...
  return (
    <div className="bg-white p-6">
      ...
      <h1 className="mb-6 text-2xl font-bold">Manage Header Contact</h1>
