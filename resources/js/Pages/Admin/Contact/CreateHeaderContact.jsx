...
const CreateHeaderContact = ({ auth }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="mt-16 flex-1 bg-neutral-50 p-6">
        <Head title="Create Header Contact | PT Ratu Bio Indonesia" />
        <Navbar auth={auth} />
        {/* Breadcrumb */}
        <nav className="mb-4 flex items-center space-x-2 font-lexend text-sm text-gray-600">
          ...
          <span className="text-gray-400">/</span>
          <span className="font-bold text-black">Create Header Contact</span>
        </nav>
        {/* Title */}
        ...
        >
          ...
          >
            {processing ? "Saving..." : "Save Header Contact"}
          </button>
        </form>
      </div>
    </div>
