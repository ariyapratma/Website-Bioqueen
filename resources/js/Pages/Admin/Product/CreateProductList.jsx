...
const CreateProductList = ({ auth, categories }) => {
  ...
  const [activeMenu, setActiveMenu] = useState("product-lists");
  ...
  const handleSubmit = (e) => {
    ...
    post("/product-lists", {
      ...
      onSuccess: () => {
        Swal.fire({
          title: "Success!",
          text: "Product Lists has been added successfully.",
          icon: "success",
          confirmButtonText: "OK",
        }).then(() => {
          Inertia.visit("/product-lists");
        });
      },
      onError: () => {
        Swal.fire({
          title: "Error!",
          text: "There was an error adding the Product Lists.",
          icon: "error",
          confirmButtonText: "OK",
        });
      },
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 bg-neutral-50 p-6">
        <Head title="Create Product Lists | PT Ratu Bio Indonesia" />
        ...
        >
          ...
          >
            {processing ? "Adding..." : "Add Product List"}
          </button>
        </form>
      </div>
    </div>
