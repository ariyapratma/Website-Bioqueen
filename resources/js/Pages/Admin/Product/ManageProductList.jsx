...
const ManageProductList = ({ dataProductList, auth }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 bg-neutral-50 p-6">
        <Head title="Manage Product Lists | PT Ratu Bio Indonesia" />
        ...
        <table className="min-w-full divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow-md">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {dataProductList.map((productList) => (
              <tr key={productList.id}>
                ...
                <td className="whitespace-nowrap px-6 py-4 font-lexend text-sm font-medium">
                  <Link
                    href={`/product-lists/${productList.id}/edit`}
