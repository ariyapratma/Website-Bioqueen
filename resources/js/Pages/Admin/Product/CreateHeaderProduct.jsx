// resources/js/Pages/CreateHeaderProduct.jsx

import { useForm } from "@inertiajs/react";
import Swal from "sweetalert2";
import { Head } from "@inertiajs/react";

const CreateHeaderProduct = () => {
    ...
    post("/header-product", {
      onSuccess: () => {
        Swal.fire({
          ...
          window.location.href = "/header-product";
        });
      },
      onError: () => {
        Swal.fire({
  ...
  return (
    <div className="bg-white p-6">
      <Head title="Add Header Product | PT Ratu Bio Indonesia" />
      <h1 className="mb-6 text-2xl font-bold">Add New Header Product</h1>
...
export default CreateHeaderProduct;
