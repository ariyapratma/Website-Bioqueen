// resources/js/Pages/ManageHeroVideo.jsx

import React from "react";
import { Link, Head, useForm } from "@inertiajs/react";
import Swal from "sweetalert2";

const ManageHeroVideo = ({ dataHeroVideo }) => {
  ...
  return (
    <div className="bg-white p-6">
      ...
      <h1 className="mb-6 text-2xl font-bold">Manage Hero Video</h1>
